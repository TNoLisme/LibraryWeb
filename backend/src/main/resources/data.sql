...
CREATE TABLE `bookcategory` (
  ...
  CONSTRAINT `FKaulvtwtf19xx3elm3pjodapne` FOREIGN KEY (`categoryid`) REFERENCES `categories` (`categoryid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FKtn2o41sb8t9v22qsd08kp3rvg` FOREIGN KEY (`bookid`) REFERENCES `books` (`bookid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `borrowrequests` (
  ...
  CONSTRAINT `FK2v86yo3igxjymktslmcpgchuy` FOREIGN KEY (`memberid`) REFERENCES `members` (`memberid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FKb46h3rrm6fobdv5q18wugo3e7` FOREIGN KEY (`bookid`) REFERENCES `books` (`bookid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `memberpenalties` (
  ...
  CONSTRAINT `FKbnxnp6j28gbwypdc6lxcx62l5` FOREIGN KEY (`memberid`) REFERENCES `members` (`memberid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FKse1ohm2lujq5tg6p6atrbml21` FOREIGN KEY (`fineid`) REFERENCES `fines` (`fineid`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `reviews` (
  ...
  CONSTRAINT `FK6wsc8rr8tb1fc782foh3mjc8q` FOREIGN KEY (`member_id`) REFERENCES `members` (`memberid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK8hdt1dv0iunluf9fn1nnvxle5` FOREIGN KEY (`borrow_request_id`) REFERENCES `borrowrequests` (`requestid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
